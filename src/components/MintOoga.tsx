...
import { Box, Flex, Grid, GridItem, Heading, Select, Text } from '@chakra-ui/react';
    ...
    <Box mt={4} border="1px solid white" p={4} borderRadius={8}>
      ...
      >
        <GridItem as={Flex} flexDir="column">
          ...
          <Select placeholder="Pick Ooga Type" value={oogaType} onChange={handleChangeOogaType}>
        ...
        <GridItem as={Flex} flexDir="column">
          ...
          <CustomNumberField defaultValue={1} min={1} max={10} onChange={handleChangeHealth} value={health} />
        </GridItem>

        <GridItem as={Flex} flexDir="column">
          <Text mb={1}>Attack:</Text>

          <CustomNumberField defaultValue={1} min={1} max={10} onChange={handleChangeAttack} value={attack} />
        </GridItem>
      </Grid>
