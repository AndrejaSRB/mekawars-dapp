...
export function useGetItemListQuery(
  ...
  return Apollo.useQuery<GetItemListQuery, GetItemListQueryVariables>(
    GetItemListDocument,
    options
  );
}
export function useGetItemListLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetItemListQuery, GetItemListQueryVariables>(
    GetItemListDocument,
    options
  );
}
export type GetItemListQueryHookResult = ReturnType<typeof useGetItemListQuery>;
export type GetItemListLazyQueryHookResult = ReturnType<
  typeof useGetItemListLazyQuery
>;
export type GetItemListQueryResult = Apollo.QueryResult<
  GetItemListQuery,
  GetItemListQueryVariables
>;
