...
export type GetMyCrewQuery = {
  ...
  crew?: {
    ...
    level?: string | null;
    durability: string;
    ntAmount?: string | null;
    mekaLeader: { __typename?: 'Ooga'; id: string };
    oogasInCrew?: Array<{ __typename?: 'Ooga'; id: string; oogaType?: number | null; level?: number | null }> | null;
    firstTeam: Array<{
      __typename?: 'Ooga';
      oogaType?: number | null;
      id: string;
      orderIndexInFirstTeam?: number | null;
    }>;
    inventory?: Array<{
    ...
    currentlyInBucket?: {
      ...
      state?: number | null;
      resolvedMatches: Array<{ __typename?: 'Match'; id: string; wonCrewId?: string | null }>;
      crewIds?: Array<{
        __typename?: 'CrewInBucket';
        id: string;
        firstTeam: Array<{ __typename?: 'Ooga'; id: string }>;
      }> | null;
    } | null;
  } | null;
};
...
export function useGetMyCrewLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetMyCrewQuery, GetMyCrewQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
