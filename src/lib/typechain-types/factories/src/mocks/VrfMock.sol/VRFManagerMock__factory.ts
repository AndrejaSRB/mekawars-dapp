...
import type { VRFManagerMock, VRFManagerMockInterface } from '../../../../src/mocks/VrfMock.sol/VRFManagerMock';
...
type VRFManagerMockConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (xs: VRFManagerMockConstructorParams): xs is ConstructorParameters<typeof ContractFactory> =>
  xs.length > 1;
...
export class VRFManagerMock__factory extends ContractFactory {
  ...
  override deploy(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<VRFManagerMock> {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): VRFManagerMock {
